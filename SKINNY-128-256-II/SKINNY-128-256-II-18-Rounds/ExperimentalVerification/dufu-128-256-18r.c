...
void init_prng(int offset) {
    ...
    unsigned int initial_seed = time(NULL)*10 + offset;
...
int main(int argc, char *argv[])
{
    ...
    char dp_str[] = "00000000000000000000000000200000";
    char dc_str[] = "40400040004000000000184000400040";

    char dk1_str[] = "0000000000000000000200000000000000000000000000000080000000000000";
    char dk2_str[] = "0000000000000000000000000000f8000000000000000000000000000000cf00";
    ...
    printf("Program number = %d", atoi(argv[1]));
