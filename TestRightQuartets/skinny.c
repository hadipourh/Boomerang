...
int main(int argc, char *argv[])
{
    ...
    char p1_st[] = "8d9a13adfc4d3d8046145385edc26a21";
    char p2_st[] = "8d9a13adfc4d3d8046145385ede26a21";
    char p3_st[] = "91b30cc8898c0324631b80319a5745de";
    char p4_st[] = "91b30cc8898c0324631b80319a7745de";

    char k1_st[] = "a733ade942312ce0503c3e528aa0c417cb47c7dad8bcefbc3f8131b6375d98de";
    char k2_st[] = "a733ade942312ce0503e3e528aa0c417cb47c7dad8bcefbc3f0131b6375d98de";
    char k3_st[] = "a733ade942312ce0503c3e528aa03c17cb47c7dad8bcefbc3f8131b6375d57de";
    char k4_st[] = "a733ade942312ce0503e3e528aa03c17cb47c7dad8bcefbc3f0131b6375d57de";

    // #######################################################################################################
    // #######################################################################################################

    convert_hexstr_to_statearray(ver, p1_st, p1);
    convert_hexstr_to_statearray(ver, p2_st, p2);
    convert_hexstr_to_statearray(ver, p3_st, p3);
    convert_hexstr_to_statearray(ver, p4_st, p4);
    convert_hexstr_to_tweakarray(ver, k1_st, k1);
    convert_hexstr_to_tweakarray(ver, k2_st, k2);
    convert_hexstr_to_tweakarray(ver, k3_st, k3);
    convert_hexstr_to_tweakarray(ver, k4_st, k4);
