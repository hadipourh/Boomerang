...
int main()
{
    ...
    int n = 1000;   // Number of independnet experiments
    ...
    char dp_str[] = "00000000000A0000";
    char dc_str[] = "0000000000000000";
                       
    char dk1_str[] = "000000000000001000000000000000C00000000000000070";
    char dk2_str[] = "000000000002000000000000000500000000000000040000";
    // 
    // sage: results = [2^(-20.272080), 2^(-19.642448), 2^(-19.955606), 2^(-20.093109), 2^(-20.272080), 2^(-20.117357), 2^(-20.045804)
    // ....: , 2^(-20.000000), 2^(-19.955606), 2^(-19.977632)]
    // sage: results.summary(digits=4)
    //      Min.   1st Qu.    Median      Mean   3rd Qu.      Max. 
    // 7.898e-07 8.829e-07 9.388e-07 9.388e-07 9.798e-07 1.222e-06
    // sage: float(log(9.388e-07, 2))
    // -20.022678822350453
    // Probability of the middle part: 2^(-20.02)
    // sage: Total probability: 
    // (2.41*2) + 20.02 + (7*2) = 38.8400000000000
    // 2^(-38.84)
    // #######################################################################################################
    // #######################################################################################################
