...
void init_prng(int offset) {
    ...
    size_t initial_seed = 11*time(NULL) + 100*(size_t)(offset);
...
int main(int argc, char *argv[])
{
    ...
    int n = 1;   // Number of independent experiments
    ...
    char dp_str[] = "00000000000000000000000000080000";
    char dc_str[] = "10100010001000000000071000100010";

    char dk1_str[] = "0000000000000000002a0000000000000000000000000000007900000000000000000000000000000033000000000000";
    char dk2_str[] = "00000000000000000000540000000000000000000000000000000f000000000000000000000000000000f80000000000";
