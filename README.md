...
- The authors of [[1]](https://tosc.iacr.org/index.php/ToSC/article/view/9976) have claimed that some characteristics in our work are impossible. All of their claims are about the characteristics of more than 10 rounds lengths. However, we never use a differential of more than 9 rounds as a building block for our distinguishers. The 6-round middle part of our distinguishers is treated as a boomerang switch where the only differences in **two different sides** of 6-round boomerang switch are fixed. Therefore, the middle 6-round in our distinguishers can not be treated as a part of a simple differential. In other words, for the middle part, only the the input difference of the upper and lower trails are fixed and the output differences are totally free. In this case, talking about a simple differential (characteristics) for the middle part does not make sense. It should clarify what is mainly wrong with the claims in [[1]](https://tosc.iacr.org/index.php/ToSC/article/view/9976). 
