...
**We noticed that Thomas Peyrin and Quan Quan Tan published a paper [[1]](https://tosc.iacr.org/index.php/ToSC/article/view/9976) including some claims about our work in ToSC-2021 [[2]](https://ia.cr/2020/1317), that misrepresents our method, unfortunately. In what follows we show that all claims in [[1]](https://tosc.iacr.org/index.php/ToSC/article/view/9976) are based on apparent misunderstanding of our method, and hence have no impact on our method/results.
