...
void init_prng(int offset) {
    ...
    unsigned int initial_seed = 10*time(NULL) + offset*100;
...
int main(int argc, char *argv[]) {
    ...
    uint8_t R = 10;//Number of rounds
    int N1 = Nthreads;
    int deg1 = 12;
    int deg2 = 12;
	UINT64 N2 = 1 << deg1;     //2^(deg1): Number of bunches per threads
	UINT64 N3 = 1 << deg2;     //2^(deg1): Number of queries per bunches

    string dp_str = "0A0000000A000000";
