...
void init_prng(int offset) {
    ...
    // unsigned int initial_seed = time(NULL) + offset*100;
    unsigned int initial_seed = 0x30051991 + offset;
...
int main(int argc, char *argv[])
{
    ...
    UINT64 N3 = 1 << 13;      // Number of queries per bunches : N3
